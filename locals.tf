locals {
  cognito_user_pool_id = var.create_pool ? resource.aws_cognito_user_pool.modern_gitops_stack_user_pool[0].id : var.cognito_user_pool_id

  cognito_user_pool_domain = var.create_pool ? resource.aws_cognito_user_pool_domain.modern_gitops_stack_user_pool_domain[0].domain : var.cognito_user_pool_domain
